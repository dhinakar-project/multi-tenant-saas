...
function ErrorCard({ title = "Error", message = "Something went wrong", onRetry }) {
    return (
            ...
            <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                        This could be due to network issues, API unavailability, or incorrect tenant configuration.
                        Please check your connection and tenant slug header.
                    </p>
